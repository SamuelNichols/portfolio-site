          ...
          <div className="lg:pl-8">
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-gray-900" href="https://github.com/SamuelNichols" target="_blank" rel="noopener noreferrer">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-gray-900" href="https://www.linkedin.com/in/samnichols359/" target="_blank" rel="noopener noreferrer">
